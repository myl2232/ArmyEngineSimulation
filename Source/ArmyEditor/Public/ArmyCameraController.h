...
/**
 * FArmyCameraControllerConfig
 *
 * Configuration data for the camera controller object
 */
class FArmyCameraControllerConfig
{
...
public:
	...
	void SetConfig( const FArmyCameraControllerConfig& InConfig )
	{
		Config = InConfig;
	}
	...
	FArmyCameraControllerConfig& GetConfig()
	{
		return Config;
	}
	...
	FArmyCameraControllerConfig& AccessConfig()
	{
		return Config;
	}
...
private:
	 ...
	 */
	void ApplyImpulseDeadZone( const FArmyCameraControllerUserImpulseData& InUserImpulse,
	 ...
	 * @param	InOutCameraPosition		[in, out] Camera position
	 */
	void UpdatePosition( const FArmyCameraControllerUserImpulseData& UserImpulse, const float DeltaTime, const float MovementSpeedScale, const FVector& CameraEuler, FVector& InOutCameraPosition );
	 ...
	 * @param	InOutCameraFOV	[in, out] Camera field of view
	 */
	void UpdateFOV( const FArmyCameraControllerUserImpulseData& UserImpulse, const float DeltaTime, float& InOutCameraFOV );
	 ...
	 */
	void UpdateRotation( const FArmyCameraControllerUserImpulseData& UserImpulse, const float DeltaTime, FVector &InOutCameraEuler );
...
private:
	...
	/** Configuration */
	FArmyCameraControllerConfig Config;
