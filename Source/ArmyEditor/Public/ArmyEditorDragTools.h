...
{
public:
	FArmyDragTool(FArmyEditorModeTools* InModeTools);
	virtual ~FArmyDragTool() {}
	 ...
	 */
	virtual void StartDrag(UArmyEditorViewportClient* InViewportClient, const FVector& InStartWorld, const FVector2D& InStartScreen);
