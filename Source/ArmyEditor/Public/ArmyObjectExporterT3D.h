...
#include "ArmyObjectExporterT3D.generated.h"
...
UCLASS()
class UArmyObjectExporterT3D : public UExporter
{
public:
	GENERATED_BODY()

public:
	UArmyObjectExporterT3D(const FObjectInitializer& ObjectInitializer = FObjectInitializer());
