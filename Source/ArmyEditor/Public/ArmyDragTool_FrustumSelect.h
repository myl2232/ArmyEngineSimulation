 ...
 */
class ARMYEDITOR_API FArmyDragTool_ActorFrustumSelect : public FArmyDragTool
{
public:
	explicit FArmyDragTool_ActorFrustumSelect(UArmyEditorViewportClient* InLevelViewportClient)
