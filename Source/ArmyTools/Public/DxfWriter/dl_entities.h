...
struct DL_EllipseData {
     ...
     * Parameters: see member variables.
     */
	DL_EllipseData(double eratio, double staparam, double endparam,
		double endX, double endY, double endZ, double centreX, double centreY, double centreZ,
...
/*
*	MLeader Dimension Data
* @ auther xiaoyi.feng
*/
struct DL_DimMLeaderData
{
	double baseX, baseY;
