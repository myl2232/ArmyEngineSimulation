...
/**
 * draws a real (double) variable to the DXF file.
 *
 * @param gc Group code.
...
/**
 * draws an int variable to the DXF file.
 *
 * @param gc Group code.
...
/**
 * draws a hex int variable to the DXF file.
 *
 * @param gc Group code.
 * @param value Int value
 */
...
void DL_WriterA::dxfMaxHandle(int gc)const
{
	char str[32];
	sprintf(str, "%I32X", 0xFFFFFFFF);
	dxfString(gc, str);
}

/**
 * draws a string variable to the DXF file.
 *
 * @param gc Group code.
 * @param value String
 */
