...
UArmyResourceManager::UArmyResourceManager()
{
	bDIYHome = true;
	bLoadDIYHome = false;
...
void UArmyResourceManager::Init()
{
	//@  欧石楠 绑定秘钥获取代理
	FCoreDelegates::GetPakEncryptionKeyDelegate().BindUObject(this, &UArmyResourceManager::GetAESKey);
	...
	//特殊定义
	StaticMIParaList.Add(-1, FArmyParameter(TEXT("漫反射贴图"), TEXT("Diffuse_UseTexture"), TEXT("Diffuse_UseTexture"), false));
	StaticMIParaList.Add(-2, FArmyParameter(TEXT("阴影贴图"), TEXT("Opacity_UseTexture"), TEXT("Opacity_UseTexture"), false));
	StaticMIParaList.Add(-3, FArmyParameter(TEXT("法线贴图编号"), TEXT("NormalMapIndex"), TEXT("NormalMapIndex"), 0.f, 100.f, -2.f));//-1默认自带法线，-2不带法线，0-N对应系统提供可选的序号
	StaticMIParaList.Add(-4, FArmyParameter(TEXT("材质类型编号"), TEXT("MaterialTypeIndex"), TEXT("MaterialTypeIndex"), 0.f, 100.f, 0.f));
	//模型材质参数对照表
	StaticMIParaList.Add(0, FArmyParameter(TEXT("环境阴影_强度"), TEXT("AO_intensity"), TEXT("AO_intensity"), 0.f, 1.f));
	StaticMIParaList.Add(1, FArmyParameter(TEXT("环境阴影_对比度"), TEXT("AO_Contrast"), TEXT("AO_Contrast"), 0.f, 1.f));
	StaticMIParaList.Add(2, FArmyParameter(TEXT("固有色"), TEXT("Color"), TEXT("Color")));
	StaticMIParaList.Add(3, FArmyParameter(TEXT("贴图混色"), TEXT("Color_Map_Blend"), TEXT("Color_Map_Blend")));
	StaticMIParaList.Add(4, FArmyParameter(TEXT("固有色_重复度_横向"), TEXT("Color_Map_Tiling_U"), TEXT("Color_Map_Tiling_U"), 0.f, 100.f));
	StaticMIParaList.Add(5, FArmyParameter(TEXT("固有色_重复度_纵向"), TEXT("Color_Map_Tiling_V"), TEXT("Color_Map_Tiling_V"), 0.f, 100.f));
	StaticMIParaList.Add(6, FArmyParameter(TEXT("固有色_旋转"), TEXT("Color_Map_RotateUV"), TEXT("Color_Map_RotateUV"), 0.f, 1.f));
	StaticMIParaList.Add(7, FArmyParameter(TEXT("自发光"), TEXT("Emissive_Color"), TEXT("Emissive_Color")));
	StaticMIParaList.Add(8, FArmyParameter(TEXT("金属"), TEXT("Metalic"), TEXT("Metalic"), 0.f, 1.f));
	StaticMIParaList.Add(9, FArmyParameter(TEXT("法线_强度"), TEXT("Normal_Intensity"), TEXT("Normal_Intensity"), -10.f, 10.f));
	StaticMIParaList.Add(10, FArmyParameter(TEXT("法线_重复度_横向"), TEXT("Normal_Map_Tiling_U"), TEXT("Normal_Map_Tiling_U"), 0.f, 100.f));
	StaticMIParaList.Add(11, FArmyParameter(TEXT("法线_重复度_纵向"), TEXT("Normal_Map_Tiling_V"), TEXT("Normal_Map_Tiling_V"), 0.f, 100.f));
	StaticMIParaList.Add(12, FArmyParameter(TEXT("法线_旋转"), TEXT("Normal_Map_RotateUV"), TEXT("Normal_Map_RotateUV"), 0.f, 1.f));
	StaticMIParaList.Add(13, FArmyParameter(TEXT("粗糙"), TEXT("Roughness"), TEXT("Roughness"), 0.f, 1.f));
	StaticMIParaList.Add(14, FArmyParameter(TEXT("高光"), TEXT("Specular"), TEXT("Specular"), 0.f, 1.f));
	StaticMIParaList.Add(15, FArmyParameter(TEXT("强度"), TEXT("Intensity"), TEXT("Intensity"), 0.f, 1.f));
	StaticMIParaList.Add(16, FArmyParameter(TEXT("固有色_偏移_横向"), TEXT("Color_Map_Offset_U"), TEXT("Color_Map_Offset_U"), 0.f, 100.f));
	StaticMIParaList.Add(17, FArmyParameter(TEXT("固有色_偏移_纵向"), TEXT("Color_Map_Offset_V"), TEXT("Color_Map_Offset_V"), 0.f, 100.f));
	StaticMIParaList.Add(18, FArmyParameter(TEXT("法线_偏移_横向"), TEXT("Normal_Map_Offset_U"), TEXT("Normal_Map_Offset_U"), 0.f, 100.f));
	StaticMIParaList.Add(19, FArmyParameter(TEXT("法线_偏移_纵向"), TEXT("Normal_Map_Offset_V"), TEXT("Normal_Map_Offset_V"), 0.f, 100.f));
	//-----------------------------------------------------100
	StaticMIParaList.Add(100, FArmyParameter(TEXT("固有色/贴图混色"), TEXT("Diffuse_Color"), TEXT("Diffuse_Color")));
	StaticMIParaList.Add(101, FArmyParameter(TEXT("固有色_偏移_横向"), TEXT("Diffuse_UV_OffsetU"), TEXT("Diffuse_UV_OffsetU"), 0.f, 100.f));
	StaticMIParaList.Add(102, FArmyParameter(TEXT("固有色_偏移_纵向"), TEXT("Diffuse_UV_OffsetV"), TEXT("Diffuse_UV_OffsetV"), 0.f, 100.f));
	StaticMIParaList.Add(103, FArmyParameter(TEXT("固有色_重复度_横向"), TEXT("Diffuse_UV_TilingU"), TEXT("Diffuse_UV_TilingU"), 0.f, 1000.f));
	StaticMIParaList.Add(104, FArmyParameter(TEXT("固有色_重复度_纵向"), TEXT("Diffuse_UV_TilingV"), TEXT("Diffuse_UV_TilingV"), 0.f, 1000.f));
	StaticMIParaList.Add(105, FArmyParameter(TEXT("固有色_旋转"), TEXT("Diffuse_UV_Rotate"), TEXT("Diffuse_UV_Rotate"), -360.f, 360.f));

	StaticMIParaList.Add(106, FArmyParameter(TEXT("环境阴影_强度"), TEXT("AO_intensity"), TEXT("AO_intensity"), 0.f, 1.f));
	StaticMIParaList.Add(107, FArmyParameter(TEXT("环境阴影_对比度"), TEXT("AO_Contrast"), TEXT("AO_Contrast"), 0.f, 1.f));

	StaticMIParaList.Add(108, FArmyParameter(TEXT("菲尼尔边缘_颜色"), TEXT("Fresnel_Color"), TEXT("Fresnel_Color")));
	StaticMIParaList.Add(109, FArmyParameter(TEXT("菲尼尔边缘_指数幂"), TEXT("Fresnel_Power"), TEXT("Fresnel_Power"), 0.f, 5.f));

	StaticMIParaList.Add(110, FArmyParameter(TEXT("固有色_色相调整"), TEXT("AdjustColor_HueShift"), TEXT("AdjustColor_HueShift"), -1.f, 1.f));
	StaticMIParaList.Add(111, FArmyParameter(TEXT("固有色_鲜艳程度"), TEXT("AdjustColor_Saturaion"), TEXT("AdjustColor_Saturaion"), 0.f, 10.f));

	StaticMIParaList.Add(112, FArmyParameter(TEXT("模拟毛绒边缘_颜色"), TEXT("Diffuse_Fuzzy_Color"), TEXT("Diffuse_Fuzzy_Color")));
	StaticMIParaList.Add(113, FArmyParameter(TEXT("模拟毛绒边缘_中心压暗"), TEXT("Diffuse_Fuzzy_CoreDarkness"), TEXT("Diffuse_Fuzzy_CoreDarkness"), 0.f, 5.f));
	StaticMIParaList.Add(114, FArmyParameter(TEXT("模拟毛绒边缘_边缘增强"), TEXT("Diffuse_Fuzzy_EdgeBrightness"), TEXT("Diffuse_Fuzzy_EdgeBrightness"), 0.f, 5.f));
	StaticMIParaList.Add(115, FArmyParameter(TEXT("模拟毛绒边缘_边缘指数幂"), TEXT("Diffuse_Fuzzy_Power"), TEXT("Diffuse_Fuzzy_Power"), 0.f, 5.f));

	StaticMIParaList.Add(116, FArmyParameter(TEXT("Diffuse_Rust"), TEXT("Diffuse_Rust"), TEXT("Diffuse_Rust"), 0.f, 1.f));
	StaticMIParaList.Add(117, FArmyParameter(TEXT("Diffuse_Silk"), TEXT("Diffuse_Silk"), TEXT("Diffuse_Silk"), 0.f, 1.f));
	StaticMIParaList.Add(118, FArmyParameter(TEXT("Diffuse_Silk_OffsetU"), TEXT("Diffuse_Silk_OffsetU"), TEXT("Diffuse_Silk_OffsetU"), 0.f, 100.f));
	StaticMIParaList.Add(119, FArmyParameter(TEXT("Diffuse_Silk_OffsetV"), TEXT("Diffuse_Silk_OffsetV"), TEXT("Diffuse_Silk_OffsetV"), 0.f, 100.f));
	StaticMIParaList.Add(120, FArmyParameter(TEXT("Diffuse_Silk_TilingU"), TEXT("Diffuse_Silk_TilingU"), TEXT("Diffuse_Silk_TilingU"), 0.f, 1000.f));
	StaticMIParaList.Add(121, FArmyParameter(TEXT("Diffuse_Silk_TilingV"), TEXT("Diffuse_Silk_TilingV"), TEXT("Diffuse_Silk_TilingV"), 0.f, 1000.f));
	StaticMIParaList.Add(122, FArmyParameter(TEXT("Diffuse_Silk_Rotate"), TEXT("Diffuse_Silk_Rotate"), TEXT("Diffuse_Silk_Rotate"), -360.f, 360.f));

	StaticMIParaList.Add(123, FArmyParameter(TEXT("固有色/贴图混色_2"), TEXT("Diffuse_2_Color"), TEXT("Diffuse_2_Color")));
	StaticMIParaList.Add(124, FArmyParameter(TEXT("固有色_2_偏移_横向"), TEXT("Diffuse_2_UV_OffsetU"), TEXT("Diffuse_2_UV_OffsetU"), 0.f, 100.f));
	StaticMIParaList.Add(125, FArmyParameter(TEXT("固有色_2_偏移_纵向"), TEXT("Diffuse_2_UV_OffsetV"), TEXT("Diffuse_2_UV_OffsetV"), 0.f, 100.f));
	StaticMIParaList.Add(126, FArmyParameter(TEXT("固有色_2_重复度_横向"), TEXT("Diffuse_2_UV_TilingU"), TEXT("Diffuse_2_UV_TilingU"), 0.f, 1000.f));
	StaticMIParaList.Add(127, FArmyParameter(TEXT("固有色_2_重复度_纵向"), TEXT("Diffuse_2_UV_TilingV"), TEXT("Diffuse_2_UV_TilingV"), 0.f, 1000.f));
	StaticMIParaList.Add(128, FArmyParameter(TEXT("固有色_2_旋转"), TEXT("Diffuse_2_UV_Rotate"), TEXT("Diffuse_2_UV_Rotate"), -360.f, 360.f));

	StaticMIParaList.Add(129, FArmyParameter(TEXT("固有色_2_色相调整"), TEXT("AdjustColor_2_HueShift"), TEXT("AdjustColor_2_HueShift"), -1.f, 1.f));
	StaticMIParaList.Add(130, FArmyParameter(TEXT("固有色_2_鲜艳程度"), TEXT("AdjustColor_2_Saturaion"), TEXT("AdjustColor_2_Saturaion"), 0.f, 10.f));
	StaticMIParaList.Add(131, FArmyParameter(TEXT("固有色_明度"), TEXT("AdjustColor_Brightness"), TEXT("AdjustColor_Brightness"), -1.f, 1.f));
	StaticMIParaList.Add(132, FArmyParameter(TEXT("固有色_2_明度"), TEXT("AdjustColor_2_Brightness"), TEXT("AdjustColor_2_Brightness"), -1.f, 1.f));
	StaticMIParaList.Add(133, FArmyParameter(TEXT("固有色_对比度"), TEXT("AdjustColor_Contrast"), TEXT("AdjustColor_Contrast"), 0.f, 1.f));
	StaticMIParaList.Add(134, FArmyParameter(TEXT("固有色_2_对比度"), TEXT("AdjustColor_2_Contrast"), TEXT("AdjustColor_2_Contrast"), 0.f, 1.f));

	StaticMIParaList.Add(135, FArmyParameter(TEXT("投射_固有色_偏移_横向"), TEXT("Projective_Diffuse_UV_OffsetU"), TEXT("Projective_Diffuse_UV_OffsetU"), 0.f, 100.f));
	StaticMIParaList.Add(136, FArmyParameter(TEXT("投射_固有色_偏移_纵向"), TEXT("Projective_Diffuse_UV_OffsetV"), TEXT("Projective_Diffuse_UV_OffsetV"), 0.f, 100.f));
	StaticMIParaList.Add(137, FArmyParameter(TEXT("投射_固有色_重复度_横向"), TEXT("Projective_Diffuse_UV_TilingU"), TEXT("Projective_Diffuse_UV_TilingU"), 0.f, 1000.f));
	StaticMIParaList.Add(138, FArmyParameter(TEXT("投射_固有色_重复度_纵向"), TEXT("Projective_Diffuse_UV_TilingV"), TEXT("Projective_Diffuse_UV_TilingV"), 0.f, 1000.f));
	StaticMIParaList.Add(139, FArmyParameter(TEXT("投射_固有色_旋转"), TEXT("Projective_Diffuse_UV_Rotate"), TEXT("Projective_Diffuse_UV_Rotate"), -360.f, 360.f));

	//-----------------------------------------------------200
	StaticMIParaList.Add(200, FArmyParameter(TEXT("金属"), TEXT("Metallic"), TEXT("Metallic"), 0.f, 1.f));
	StaticMIParaList.Add(201, FArmyParameter(TEXT("金属_2"), TEXT("Metallic_2"), TEXT("Metallic_2"), 0.f, 1.f));
	//-----------------------------------------------------300
	StaticMIParaList.Add(300, FArmyParameter(TEXT("高光"), TEXT("Specular"), TEXT("Specular"), 0.f, 1.f));
	StaticMIParaList.Add(301, FArmyParameter(TEXT("高光_2"), TEXT("Specular_2"), TEXT("Specular_2"), 0.f, 1.f));

	StaticMIParaList.Add(302, FArmyParameter(TEXT("高光_对比度"), TEXT("Specular_Contrast"), TEXT("Specular_Contrast"), 0.f, 1.f));
	StaticMIParaList.Add(303, FArmyParameter(TEXT("高光_偏移_横向"), TEXT("Specular_UV_Offset_U"), TEXT("Specular_UV_Offset_U"), 0.f, 100.f));
	StaticMIParaList.Add(304, FArmyParameter(TEXT("高光_偏移_纵向"), TEXT("Specular_UV_Offset_V"), TEXT("Specular_UV_Offset_V"), 0.f, 100.f));
	StaticMIParaList.Add(305, FArmyParameter(TEXT("高光_重复度_横向"), TEXT("Specular_UV_Tiling_U"), TEXT("Specular_UV_Tiling_U"), 0.f, 1000.f));
	StaticMIParaList.Add(306, FArmyParameter(TEXT("高光_重复度_纵向"), TEXT("Specular_UV_Tiling_V"), TEXT("Specular_UV_Tiling_V"), 0.f, 1000.f));
	StaticMIParaList.Add(307, FArmyParameter(TEXT("高光_旋转"), TEXT("Specular_UV_Ratote"), TEXT("Specular_UV_Ratote"), -360.f, 360.f));

	StaticMIParaList.Add(308, FArmyParameter(TEXT("高光_2_对比度"), TEXT("Specular_2_Contrast"), TEXT("Specular_2_Contrast"), 0.f, 1.f));
	StaticMIParaList.Add(309, FArmyParameter(TEXT("高光_2_偏移_横向"), TEXT("Specular_2_UV_Offset_U"), TEXT("Specular_2_UV_Offset_U"), 0.f, 100.f));
	StaticMIParaList.Add(310, FArmyParameter(TEXT("高光_2_偏移_纵向"), TEXT("Specular_2_UV_Offset_V"), TEXT("Specular_2_UV_Offset_V"), 0.f, 100.f));
	StaticMIParaList.Add(311, FArmyParameter(TEXT("高光_2_重复度_横向"), TEXT("Specular_2_UV_Tiling_U"), TEXT("Specular_2_UV_Tiling_U"), 0.f, 1000.f));
	StaticMIParaList.Add(312, FArmyParameter(TEXT("高光_2_重复度_纵向"), TEXT("Specular_2_UV_Tiling_V"), TEXT("Specular_2_UV_Tiling_V"), 0.f, 1000.f));
	StaticMIParaList.Add(313, FArmyParameter(TEXT("高光_2_旋转"), TEXT("Specular_2_UV_Rotate"), TEXT("Specular_2_UV_Rotate"), -360.f, 360.f));

	StaticMIParaList.Add(314, FArmyParameter(TEXT("投射_高光_偏移_横向"), TEXT("Projective_Specular_UV_Offset_U"), TEXT("Projective_Specular_UV_Offset_U"), 0.f, 100.f));
	StaticMIParaList.Add(315, FArmyParameter(TEXT("投射_高光_偏移_纵向"), TEXT("Projective_Specular_UV_Offset_V"), TEXT("Projective_Specular_UV_Offset_V"), 0.f, 100.f));
	StaticMIParaList.Add(316, FArmyParameter(TEXT("投射_高光_重复度_横向"), TEXT("Projective_Specular_UV_Tiling_U"), TEXT("Projective_Specular_UV_Tiling_U"), 0.f, 1000.f));
	StaticMIParaList.Add(317, FArmyParameter(TEXT("投射_高光_重复度_纵向"), TEXT("Projective_Specular_UV_Tiling_V"), TEXT("Projective_Specular_UV_Tiling_V"), 0.f, 1000.f));
	StaticMIParaList.Add(318, FArmyParameter(TEXT("投射_高光_旋转"), TEXT("Projective_Specular_UV_Ratote"), TEXT("Projective_Specular_UV_Ratote"), -360.f, 360.f));
	//-----------------------------------------------------400
	StaticMIParaList.Add(400, FArmyParameter(TEXT("粗糙度"), TEXT("Roughness"), TEXT("Roughness"), 0.f, 1.f));
	StaticMIParaList.Add(401, FArmyParameter(TEXT("Roughness_ScurbMetal"), TEXT("Roughness_ScurbMetal"), TEXT("Roughness_ScurbMetal"), 0.f, 5.f));
	StaticMIParaList.Add(402, FArmyParameter(TEXT("Roughness_ScurbMetal_Texture"), TEXT("Roughness_ScurbMetal_Texture"), TEXT("Roughness_ScurbMetal_Texture"), 0.f, 1.f));
	StaticMIParaList.Add(403, FArmyParameter(TEXT("最大粗糙度"), TEXT("Roughness_Min"), TEXT("Roughness_Min"), 0.f, 1.f));
	StaticMIParaList.Add(404, FArmyParameter(TEXT("最小粗糙度"), TEXT("Roughness_Max"), TEXT("Roughness_Max"), 0.f, 1.f));
	StaticMIParaList.Add(405, FArmyParameter(TEXT("粗糙度_2"), TEXT("Roughness_2"), TEXT("Roughness_2"), 0.f, 1.f));

	//StaticMIParaList.Add(406, FArmyParameter(TEXT("粗糙度_对比度"), TEXT("Roughness_Contrast"), TEXT("Roughness_Contrast"), 0.f, 1.f));
	//StaticMIParaList.Add(407, FArmyParameter(TEXT("粗糙度_偏移_横向"), TEXT("Roughness_UV_Offset_U"), TEXT("Roughness_UV_Offset_U"), 0.f, 100.f));
	//StaticMIParaList.Add(408, FArmyParameter(TEXT("粗糙度_偏移_纵向"), TEXT("Roughness_UV_Offset_V"), TEXT("Roughness_UV_Offset_V"), 0.f, 100.f));
	//StaticMIParaList.Add(409, FArmyParameter(TEXT("粗糙度_重复度_横向"), TEXT("Roughness_UV_Tiling_U"), TEXT("Roughness_UV_Tiling_U"), 0.f, 100.f));
	//StaticMIParaList.Add(410, FArmyParameter(TEXT("粗糙度_重复度_纵向"), TEXT("Roughness_UV_Tiling_V"), TEXT("Roughness_UV_Tiling_V"), 0.f, 100.f));
	//StaticMIParaList.Add(411, FArmyParameter(TEXT("粗糙度_旋转"), TEXT("Roughness_UV_Ratote"), TEXT("Roughness_UV_Ratote"), -360.f, 360.f));

	//StaticMIParaList.Add(412, FArmyParameter(TEXT("粗糙度_2_对比度"), TEXT("Roughness_2_Contrast"), TEXT("Roughness_2_Contrast"), 0.f, 1.f));
	//StaticMIParaList.Add(413, FArmyParameter(TEXT("粗糙度_2_偏移_横向"), TEXT("Roughness_2_UV_Offset_U"), TEXT("Roughness_2_UV_Offset_U"), 0.f, 100.f));
	//StaticMIParaList.Add(414, FArmyParameter(TEXT("粗糙度_2_偏移_纵向"), TEXT("Roughness_2_UV_Offset_V"), TEXT("Roughness_2_UV_Offset_V"), 0.f, 100.f));
	//StaticMIParaList.Add(415, FArmyParameter(TEXT("粗糙度_2_重复度_横向"), TEXT("Roughness_2_UV_Tiling_U"), TEXT("Roughness_2_UV_Tiling_U"), 0.f, 1000.f));
	//StaticMIParaList.Add(416, FArmyParameter(TEXT("粗糙度_2_重复度_纵向"), TEXT("Roughness_2_UV_Tiling_V"), TEXT("Roughness_2_UV_Tiling_V"), 0.f, 1000.f));
	//StaticMIParaList.Add(417, FArmyParameter(TEXT("粗糙度_2_旋转"), TEXT("Roughness_2_UV_Rotate"), TEXT("Roughness_2_UV_Rotate"), -360.f, 360.f));

	//StaticMIParaList.Add(418, FArmyParameter(TEXT("投射_粗糙度_偏移_横向"), TEXT("Projective_Roughness_UV_Offset_U"), TEXT("Projective_Roughness_UV_Offset_U"), 0.f, 100.f));
	//StaticMIParaList.Add(419, FArmyParameter(TEXT("投射_粗糙度_偏移_纵向"), TEXT("Projective_Roughness_UV_Offset_V"), TEXT("Projective_Roughness_UV_Offset_V"), 0.f, 100.f));
	//StaticMIParaList.Add(420, FArmyParameter(TEXT("投射_粗糙度_重复度_横向"), TEXT("Projective_Roughness_UV_Tiling_U"), TEXT("Projective_Roughness_UV_Tiling_U"), 0.f, 1000.f));
	//StaticMIParaList.Add(421, FArmyParameter(TEXT("投射_粗糙度_重复度_纵向"), TEXT("Projective_Roughness_UV_Tiling_V"), TEXT("Projective_Roughness_UV_Tiling_V"), 0.f, 1000.f));
	//StaticMIParaList.Add(422, FArmyParameter(TEXT("投射_粗糙度_旋转"), TEXT("Projective_Roughness_UV_Ratote"), TEXT("Projective_Roughness_UV_Ratote"), -360.f, 360.f));

	//-----------------------------------------------------500
	StaticMIParaList.Add(500, FArmyParameter(TEXT("自发光"), TEXT("Emissive_Color"), TEXT("Emissive_Color"), 0.f, 1.f));
	StaticMIParaList.Add(501, FArmyParameter(TEXT("焦散_着色"), TEXT("Caustic_ColorTint"), TEXT("Caustic_ColorTint")));
	StaticMIParaList.Add(502, FArmyParameter(TEXT("焦散_强度"), TEXT("Caustic_Intensity"), TEXT("Caustic_Intensity"), 0.f, 200000.f));
	StaticMIParaList.Add(503, FArmyParameter(TEXT("焦散_颜色指数幂"), TEXT("Caustic_Power"), TEXT("Caustic_Power"), 1.f, 5.f));
	StaticMIParaList.Add(504, FArmyParameter(TEXT("焦散_尺寸"), TEXT("Caustic_Size"), TEXT("Caustic_Size"), 0.f, 1000.f));
	StaticMIParaList.Add(505, FArmyParameter(TEXT("焦散_长宽比"), TEXT("Caustic_UVratio"), TEXT("Caustic_UVratio"), 0.f, 5000.f));
	StaticMIParaList.Add(506, FArmyParameter(TEXT("焦散_彩度"), TEXT("Caustic_Chrome"), TEXT("Caustic_Chrome"), 0.f, 1.f));
	StaticMIParaList.Add(507, FArmyParameter(TEXT("焦散_扰乱_尺寸"), TEXT("Caustic_Disdort_Size"), TEXT("Caustic_Disdort_Size"), 0.f, 10.f));
	StaticMIParaList.Add(508, FArmyParameter(TEXT("焦散_扰乱_速度"), TEXT("Caustic_Disdort_Speed"), TEXT("Caustic_Disdort_Speed"), 0.f, 1.f));

	StaticMIParaList.Add(509, FArmyParameter(TEXT("自发光_遮罩_重复度_纵向"), TEXT("EmissiveMask_UV_TilingU"), TEXT("EmissiveMask_UV_TilingU"), 0.f, 1000.f));
	StaticMIParaList.Add(510, FArmyParameter(TEXT("自发光_遮罩_重复度_横向"), TEXT("EmissiveMask_UV_TilingV"), TEXT("EmissiveMask_UV_TilingV"), 0.f, 1000.f));
	StaticMIParaList.Add(511, FArmyParameter(TEXT("自发光_遮罩_偏移_横向"), TEXT("EmissiveMask_UV_OffsetU"), TEXT("EmissiveMask_UV_OffsetU"), 0.f, 100.f));
	StaticMIParaList.Add(512, FArmyParameter(TEXT("自发光_遮罩_偏移_纵向"), TEXT("EmissiveMask_UV_OffsetV"), TEXT("EmissiveMask_UV_OffsetV"), 0.f, 100.f));
	StaticMIParaList.Add(513, FArmyParameter(TEXT("自发光_遮罩_旋转"), TEXT("EmissiveMask_UV_Rotate"), TEXT("EmissiveMask_UV_Rotate"), -360.f, 360.f));
	StaticMIParaList.Add(514, FArmyParameter(TEXT("自发光_遮罩_反相"), TEXT("EmissiveMask_Invert"), TEXT("EmissiveMask_Invert"), 0.f, 1.f));
	StaticMIParaList.Add(515, FArmyParameter(TEXT("自发光_遮罩_对比度"), TEXT("EmissiveMask_Contrast"), TEXT("EmissiveMask_Contrast"), 0.f, 10.f));
	StaticMIParaList.Add(516, FArmyParameter(TEXT("自发光_遮罩_偏移"), TEXT("EmissiveMask_Offset"), TEXT("EmissiveMask_Offset"), -1.f, 1.f));

	//-----------------------------------------------------600
	StaticMIParaList.Add(600, FArmyParameter(TEXT("法线_强度"), TEXT("Normal_Strength"), TEXT("Normal_Strength"), -5.f, 5.f));
	StaticMIParaList.Add(601, FArmyParameter(TEXT("法线_偏移_横向"), TEXT("NormalMap_UV_Offset_U"), TEXT("NormalMap_UV_Offset_U"), 0.f, 100.f));
	StaticMIParaList.Add(602, FArmyParameter(TEXT("法线_偏移_纵向"), TEXT("NormalMap_UV_Offset_V"), TEXT("NormalMap_UV_Offset_V"), 0.f, 100.f));
	StaticMIParaList.Add(603, FArmyParameter(TEXT("法线_重复度_横向"), TEXT("NormalMap_UV_Tiling_U"), TEXT("NormalMap_UV_Tiling_U"), 0.f, 1000.f));
	StaticMIParaList.Add(604, FArmyParameter(TEXT("法线_重复度_纵向"), TEXT("NormalMap_UV_Tiling_V"), TEXT("NormalMap_UV_Tiling_V"), 0.f, 1000.f));
	StaticMIParaList.Add(605, FArmyParameter(TEXT("法线_旋转"), TEXT("NormalMap_UV_Rotate"), TEXT("NormalMap_UV_Ratote"), -360.f, 360.f));
	StaticMIParaList.Add(606, FArmyParameter(TEXT("细节法线_强度"), TEXT("NormalDetail_Strength"), TEXT("NormalDetail_Strength"), -5.f, 5.f));
	StaticMIParaList.Add(607, FArmyParameter(TEXT("细节法线_偏移_横向"), TEXT("NormalDetial_UV_Offset_U"), TEXT("NormalDetial_UV_Offset_U"), 0.f, 100.f));
	StaticMIParaList.Add(608, FArmyParameter(TEXT("细节法线_偏移_纵向"), TEXT("NormalDetial_UV_Offset_V"), TEXT("NormalDetial_UV_Offset_V"), 0.f, 100.f));
	StaticMIParaList.Add(609, FArmyParameter(TEXT("细节法线_重复度_横向"), TEXT("NormalDetial_UV_Tiling_U"), TEXT("NormalDetial_UV_Tiling_U"), 0.f, 1000.f));
	StaticMIParaList.Add(610, FArmyParameter(TEXT("细节法线_重复度_纵向"), TEXT("NormalDetial_UV_Tiling_V"), TEXT("NormalDetial_UV_Tiling_V"), 0.f, 1000.f));
	StaticMIParaList.Add(611, FArmyParameter(TEXT("细节法线_旋转"), TEXT("NormalDetial_UV_Rotate"), TEXT("NormalDetial_UV_Ratote"), -360.f, 360.f));

	StaticMIParaList.Add(612, FArmyParameter(TEXT("法线_强度_2"), TEXT("Normal_2_Strength"), TEXT("Normal_2_Strength"), -5.f, 5.f));
	StaticMIParaList.Add(613, FArmyParameter(TEXT("法线_偏移_横向_2"), TEXT("NormalMap_2_UV_Offset_U"), TEXT("NormalMap_2_UV_Offset_U"), 0.f, 100.f));
	StaticMIParaList.Add(614, FArmyParameter(TEXT("法线_偏移_纵向_2"), TEXT("NormalMap_2_UV_Offset_V"), TEXT("NormalMap_2_UV_Offset_V"), 0.f, 100.f));
	StaticMIParaList.Add(615, FArmyParameter(TEXT("法线_重复度_横向_2"), TEXT("NormalMap_2_UV_Tiling_U"), TEXT("NormalMap_2_UV_Tiling_U"), 0.f, 1000.f));
	StaticMIParaList.Add(616, FArmyParameter(TEXT("法线_重复度_纵向_2"), TEXT("NormalMap_2_UV_Tiling_V"), TEXT("NormalMap_2_UV_Tiling_V"), 0.f, 1000.f));
	StaticMIParaList.Add(617, FArmyParameter(TEXT("法线_旋转_2"), TEXT("NormalMap_2_UV_Ratote"), TEXT("NormalMap_2_UV_Ratote"), -360.f, 360.f));

	StaticMIParaList.Add(618, FArmyParameter(TEXT("投射_法线_偏移_横向"), TEXT("Projective_NormalMap_UV_Offset_U"), TEXT("Projective_NormalMap_UV_Offset_U"), 0.f, 100.f));
	StaticMIParaList.Add(619, FArmyParameter(TEXT("投射_法线_偏移_纵向"), TEXT("Projective_NormalMap_UV_Offset_V"), TEXT("Projective_NormalMap_UV_Offset_V"), 0.f, 100.f));
	StaticMIParaList.Add(620, FArmyParameter(TEXT("投射_法线_重复度_横向"), TEXT("Projective_NormalMap_UV_Tiling_U"), TEXT("Projective_NormalMap_UV_Tiling_U"), 0.f, 1000.f));
	StaticMIParaList.Add(621, FArmyParameter(TEXT("投射_法线_重复度_纵向"), TEXT("Projective_NormalMap_UV_Tiling_V"), TEXT("Projective_NormalMap_UV_Tiling_V"), 0.f, 1000.f));
	StaticMIParaList.Add(622, FArmyParameter(TEXT("投射_法线_旋转"), TEXT("Projective_NormalMap_UV_Ratote"), TEXT("Projective_NormalMap_UV_Ratote"), -360.f, 360.f));

	//---------------------------------------------------700
	StaticMIParaList.Add(700, FArmyParameter(TEXT("透明度"), TEXT("Opacity"), TEXT("Opacity"), 0.f, 1.f));
	StaticMIParaList.Add(701, FArmyParameter(TEXT("透明影响模糊"), TEXT("Mask_AffectBlur"), TEXT("Mask_AffectBlur"), 0.f, 1.f));
	StaticMIParaList.Add(702, FArmyParameter(TEXT("透明影响反射率"), TEXT("Mask_AffectRefraction"), TEXT("Mask_AffectRefraction"), 0.f, 1.f));
	StaticMIParaList.Add(703, FArmyParameter(TEXT("Hollow-out_Style"), TEXT("Hollow-out_Style"), TEXT("Hollow-out_Style"), 0.f, 5.f));
	StaticMIParaList.Add(704, FArmyParameter(TEXT("遮罩_法线强度"), TEXT("Hollow-out_NormalStrength"), TEXT("Hollow-out_NormalStrength"), -5.f, 5.f));
	StaticMIParaList.Add(705, FArmyParameter(TEXT("遮罩_偏移_横向"), TEXT("Hollow-out_UV_OffsetU"), TEXT("Hollow-out_UV_OffsetU"), 0.f, 100.f));
	StaticMIParaList.Add(706, FArmyParameter(TEXT("遮罩_偏移_纵向"), TEXT("Hollow-out_UV_OffsetV"), TEXT("Hollow-out_UV_OffsetV"), 0.f, 100.f));
	StaticMIParaList.Add(707, FArmyParameter(TEXT("遮罩_旋转"), TEXT("Hollow-out_UV_Rotate"), TEXT("Hollow-out_UV_Rotate"), -360.f, 360.f));
	StaticMIParaList.Add(708, FArmyParameter(TEXT("遮罩_重复度_纵向"), TEXT("Hollow-out_UV_TilingU"), TEXT("Hollow-out_UV_TilingU"), 0.f, 1000.f));
	StaticMIParaList.Add(709, FArmyParameter(TEXT("遮罩_重复度_横向"), TEXT("Hollow-out_UV_TilingV"), TEXT("Hollow-out_UV_TilingV"), 0.f, 1000.f));
	StaticMIParaList.Add(710, FArmyParameter(TEXT("次表面散射_透光率"), TEXT("SSS_Opacity"), TEXT("SSS_Opacity"), 0.f, 1.f));
	StaticMIParaList.Add(711, FArmyParameter(TEXT("次表面散射_内部材质颜色"), TEXT("SSS_Color"), TEXT("SSS_Color")));
	StaticMIParaList.Add(712, FArmyParameter(TEXT("次表面散射_固有色混色"), TEXT("SSS_Color_BlendWithDiffuse"), TEXT("SSS_Color_BlendWithDiffuse"), 0.f, 1.f));
	StaticMIParaList.Add(713, FArmyParameter(TEXT("透明度_指数幂"), TEXT("Opacity_Power"), TEXT("Opacity_Power"), 0.f, 5.f));
	StaticMIParaList.Add(714, FArmyParameter(TEXT("最小透明度"), TEXT("Opacity_Min"), TEXT("Opacity_Min"), 0.f, 1.f));
	StaticMIParaList.Add(715, FArmyParameter(TEXT("最大透明度"), TEXT("Opacity_Max"), TEXT("Opacity_Max"), 0.f, 1.f));
	StaticMIParaList.Add(716, FArmyParameter(TEXT("透明度贴图_黑色透明度"), TEXT("Mask_Map_Color1"), TEXT("Mask_Map_Color1"), 0.f, 1.f));
	StaticMIParaList.Add(717, FArmyParameter(TEXT("透明度贴图_白色透明度"), TEXT("Mask_Map_Color2"), TEXT("Mask_Map_Color2"), 0.f, 1.f));
	StaticMIParaList.Add(718, FArmyParameter(TEXT("深度衰减"), TEXT("Opacity_FadeDistance"), TEXT("Opacity_FadeDistance"), 0.f, 1000.f));
	StaticMIParaList.Add(719, FArmyParameter(TEXT("遮罩_相反"), TEXT("Mask_Invert"), TEXT("Mask_Invert"), 0.f, 1.f));
	StaticMIParaList.Add(720, FArmyParameter(TEXT("遮罩_偏移"), TEXT("Mask_Offset"), TEXT("Mask_Offset"), -1.f, 1.f));
	StaticMIParaList.Add(721, FArmyParameter(TEXT("遮罩_对比度"), TEXT("Mask_Contrast"), TEXT("Mask_Contrast"), 0.f, 10.f));

	StaticMIParaList.Add(722, FArmyParameter(TEXT("透明度_重复度_纵向"), TEXT("Opacity_UV_TilingU"), TEXT("Opacity_UV_TilingU"), 0.f, 1000.f));
	StaticMIParaList.Add(723, FArmyParameter(TEXT("透明度_重复度_横向"), TEXT("Opacity_UV_TilingV"), TEXT("Opacity_UV_TilingV"), 0.f, 1000.f));
	StaticMIParaList.Add(724, FArmyParameter(TEXT("透明度_偏移_横向"), TEXT("Opacity_UV_OffsetU"), TEXT("Opacity_UV_OffsetU"), 0.f, 100.f));
	StaticMIParaList.Add(725, FArmyParameter(TEXT("透明度_偏移_纵向"), TEXT("Opacity_UV_OffsetV"), TEXT("Opacity_UV_OffsetV"), 0.f, 100.f));
	StaticMIParaList.Add(726, FArmyParameter(TEXT("透明度_旋转"), TEXT("Opacity_UV_Rotate"), TEXT("Opacity_UV_Rotate"), -360.f, 360.f));
	StaticMIParaList.Add(727, FArmyParameter(TEXT("透明度_反相"), TEXT("Opacity_Invert"), TEXT("Opacity_Invert"), 0.f, 1.f));
	StaticMIParaList.Add(728, FArmyParameter(TEXT("透明度_对比度"), TEXT("Opacity_Contrast"), TEXT("Opacity_Contrast"), 0.f, 10.f));
	StaticMIParaList.Add(729, FArmyParameter(TEXT("透明度_偏移"), TEXT("Opacity_Offset"), TEXT("Opacity_Offset"), -1.f, 1.f));

	StaticMIParaList.Add(730, FArmyParameter(TEXT("层遮罩_重复度_纵向"), TEXT("LayerMask_UV_TilingU"), TEXT("LayerMask_UV_TilingU"), 0.f, 1000.f));
	StaticMIParaList.Add(731, FArmyParameter(TEXT("层遮罩_重复度_横向"), TEXT("LayerMask_UV_TilingV"), TEXT("LayerMask_UV_TilingV"), 0.f, 1000.f));
	StaticMIParaList.Add(732, FArmyParameter(TEXT("层遮罩_偏移_横向"), TEXT("LayerMask_UV_OffsetU"), TEXT("LayerMask_UV_OffsetU"), 0.f, 100.f));
	StaticMIParaList.Add(733, FArmyParameter(TEXT("层遮罩_偏移_纵向"), TEXT("LayerMask_UV_OffsetV"), TEXT("LayerMask_UV_OffsetV"), 0.f, 100.f));
	StaticMIParaList.Add(734, FArmyParameter(TEXT("层遮罩_旋转"), TEXT("LayerMask_UV_Rotate"), TEXT("LayerMask_UV_Rotate"), -360.f, 360.f));
	StaticMIParaList.Add(735, FArmyParameter(TEXT("层遮罩_反相"), TEXT("LayerMask_Invert"), TEXT("LayerMask_Invert"), 0.f, 1.f));
	StaticMIParaList.Add(736, FArmyParameter(TEXT("层遮罩_对比度"), TEXT("LayerMask_Contrast"), TEXT("LayerMask_Contrast"), 0.f, 10.f));
	StaticMIParaList.Add(737, FArmyParameter(TEXT("层遮罩_偏移"), TEXT("LayerMask_Offset"), TEXT("LayerMask_Offset"), -1.f, 1.f));

	//-----------------------------------------------------800
	StaticMIParaList.Add(800, FArmyParameter(TEXT("折射率"), TEXT("Refraction_Bias"), TEXT("Refraction_Bias"), -1.f, 1.f));
	StaticMIParaList.Add(801, FArmyParameter(TEXT("RefractionMap_Strength"), TEXT("RefractionMap_Strength"), TEXT("RefractionMap_Strength"), 0.f, 1.f));
	StaticMIParaList.Add(802, FArmyParameter(TEXT("RefractionMap_Repeat"), TEXT("RefractionMap_Repeat"), TEXT("RefractionMap_Repeat"), 0.f, 1000.f));
	StaticMIParaList.Add(803, FArmyParameter(TEXT("RefractionMap_UVratio"), TEXT("RefractionMap_UVratio"), TEXT("RefractionMap_UVratio"), 0.f, 1000.f));
	//-----------------------------------------------------900
	StaticMIParaList.Add(900, FArmyParameter(TEXT("模糊度"), TEXT("Blur_Distance"), TEXT("Blur_Distance"), 0.f, 1.f));
	StaticMIParaList.Add(901, FArmyParameter(TEXT("速度"), TEXT("Speed"), TEXT("Speed"), 0.f, 10.f));
	StaticMIParaList.Add(902, FArmyParameter(TEXT("位置偏移"), TEXT("PositionOffset"), TEXT("PositionOffset"), 0.f, 10.f));
	StaticMIParaList.Add(903, FArmyParameter(TEXT("AO影响偏移"), TEXT("AO_AffectOffset"), TEXT("AO_AffectOffset"), 0.f, 1.f));
	StaticMIParaList.Add(904, FArmyParameter(TEXT("偏移密度"), TEXT("OffsetDensity"), TEXT("OffsetDensity"), 1.f, 256.f));
	...
	//模型属性参数列表
	//-----------------------------------------------------
	StaticModelParaList.Add(0, FArmyParameter(TEXT("点光源投影"), TEXT("PointLightCastShadow"), TEXT("PointLightCastShadow"), false));
	StaticModelParaList.Add(1, FArmyParameter(TEXT("点光源亮度"), TEXT("PointLightIntensity"), TEXT("PointLightIntensity"), 0.f, 20000.f));
	StaticModelParaList.Add(2, FArmyParameter(TEXT("点光源半径"), TEXT("PointLightRadius"), TEXT("PointLightRadius"), 0.f, 1000.f));
	StaticModelParaList.Add(3, FArmyParameter(TEXT("点光源颜色"), TEXT("PointLightColor"), TEXT("PointLightColor")));
	StaticModelParaList.Add(4, FArmyParameter(TEXT("射灯投影"), TEXT("SpotLightCastShadow"), TEXT("SpotLightCastShadow"), false));
	StaticModelParaList.Add(5, FArmyParameter(TEXT("射灯亮度"), TEXT("SpotLightIntensity"), TEXT("SpotLightIntensity"), 0.f, 20000.f));
	StaticModelParaList.Add(6, FArmyParameter(TEXT("射灯半径"), TEXT("SpotLightRadius"), TEXT("SpotLightRadius"), 0.f, 1000.f));
	StaticModelParaList.Add(7, FArmyParameter(TEXT("射灯内角"), TEXT("SpotLightInnerAngle"), TEXT("SpotLightInnerAngle"), 0.f, 90.f));
	StaticModelParaList.Add(8, FArmyParameter(TEXT("射灯外角"), TEXT("SpotLightOutterAngle"), TEXT("SpotLightOutterAngle"), 0.f, 90.f));
	StaticModelParaList.Add(9, FArmyParameter(TEXT("射灯颜色"), TEXT("SpotLightColor"), TEXT("SpotLightColor")));
	StaticModelParaList.Add(10, FArmyParameter(TEXT("射灯IES"), TEXT("SpotLightIES"), TEXT("SpotLightIES"), 0.f, 1.f));
	...
	//GVRSEditor->OnLevelActorAdded.AddDynamic(this, &UArmyResourceManager::OnActorPasted);

	LoadCommonData();
}

void UArmyResourceManager::BeginDestroy()
{
	Super::BeginDestroy();
...
FString UArmyResourceManager::GetDebugInfo()
{
	FString DebugStr;
...
EResourceType UArmyResourceManager::GetFileType(FString _PakName)
{
...
FVector UArmyResourceManager::GetVecFromColor(FLinearColor _Color)
{
	FVector Vec;
	Vec.X = _Color.R;
	Vec.Y = _Color.G;
...
FString UArmyResourceManager::GetPathFromFileName(EResourceType _PakType, FString& _PakName, bool _Test)
{
	FString FilePath;
	//绘制户型文件
...
int32 UArmyResourceManager::GetItemIDFromObj(UObject* _Obj)
{
	if (_Obj)
	{
...
int32 UArmyResourceManager::GetItemIDFromActor(AActor* _Actor)
{
	if (_Actor)
	{
...
FVRSObject* UArmyResourceManager::GetObjFromObjID(int32 _ObjID)
{
...
TSharedPtr<FContentItemSpace::FContentItem> UArmyResourceManager::GetContentItemFromID(int32 _SynID)
{
...
TSharedPtr<FContentItemSpace::FContentItem> UArmyResourceManager::GetContentItemFromItemID(EResourceType InResType, int32 InID)
{
	for (auto& It : SynList)
	{
...
TSharedPtr<FContentItemSpace::FContentItem> UArmyResourceManager::GetContentItemFromItemID(int32 InID)
{
    for (auto& It : SynList)
    {
        if (It->ID == InID)
...
FString UArmyResourceManager::GetMaterialFullName(UMaterialInterface* _MI)
{
...
void UArmyResourceManager::GetParentMostPath(UMaterialInterface* _MI, TArray<FString>& _Paths)
{
	TempPaths.Reset();
...
void UArmyResourceManager::GetParentMostPathInternal(UMaterialInterface* _MI)
{
	while (true)
	{
		UMaterialInstanceDynamic* MID = Cast<UMaterialInstanceDynamic>(_MI);
...
FString UArmyResourceManager::GetCurMapPakName()
{
...
FString UArmyResourceManager::FindLevelPath(FString _HomePakName, bool _Test)
{
	FString LevelPath;
	FString PakPath = UArmyResourceManager::GetPathFromFileName(EResourceType::CookedHome, _HomePakName, _Test);
...
bool UArmyResourceManager::CloneObject(UObject* _NewObject, UObject* _OldObject)
{
	//根据ObjID查找原有Obj
...
UMaterialInstanceDynamic* UArmyResourceManager::CreateMID(UMaterialInterface* _MI)
{
	if (_MI)
	{
...
EFileExistenceState UArmyResourceManager::CheckFileExistState(FString _FilePath, FString _NetMD5)
{
	...
	// 是否正在下载
	if (FArmyDownloadModule::Get().GetDownloadManager()->GetTask(FileName).IsValid())
	{
...
UStaticMeshComponent* UArmyResourceManager::GetActorSMC(AActor* _InActor)
{
...
EActorType UArmyResourceManager::GetActorType(AActor* _InActor)
{
	AStaticMeshActor* SMA = Cast<AStaticMeshActor>(_InActor);
	if (SMA)
	{
...
AActor* UArmyResourceManager::CreateActor(UWorld* _OwnerWorld, TSharedPtr<FContentItemSpace::FContentItem> _SynData, FVector _Location, FRotator _Rotation, FVector _Scale)
{
...
UMaterialInterface* UArmyResourceManager::CreateMaterial(UWorld* _OwnerWorld, TSharedPtr<FContentItemSpace::FContentItem> _SynData)
{
	CurWorld = _OwnerWorld;
...
AActor* UArmyResourceManager::CreateCustomActor(UWorld* _OwnerWorld, FString _FilePath, FVector _Location, FRotator _Rotation, FVector _Scale)
{
	CurWorld = _OwnerWorld;
	int32 OutSynID, OutObjID;
	AActor* NewActor = NULL;
	...
	ModelRes.Add(MakeShareable(new FContentItemSpace::FModelRes(FileName, _FilePath, "", "0", EResourceType::Texture, "", "")));
...
UMaterialInterface* UArmyResourceManager::CreateCustomMaterial(FString _FilePath)
{
...
UMaterialInterface* UArmyResourceManager::CreateContentItemMaterial(TSharedPtr<FContentItemSpace::FContentItem> ContentItem)
{
	...
	int32 OutSynID, OutObjID;
	UMaterialInterface* NewMaterial = NULL;
	FVRSObject* NewVRSObj = LoadCustomObj(ContentItem, OutObjID, OutSynID);
	if (NewVRSObj)
	{
		NewMaterial = CreateMaterialInternal(NewVRSObj, OutObjID, OutSynID);
		TArray<TSharedPtr<FContentItemSpace::FResObj> >resArr = ContentItem->GetResObjNoComponent();
		if (resArr.Num() >= 1)
		{
			...
			int number = resArr.Num();
			for (int i = 0; i < number; i++)
			{
				if (resArr[i]->ResourceType == EResourceType::Texture || resArr[i]->ResourceType == EResourceType::Material)
				{
					TSharedPtr<FContentItemSpace::FArmyHardModeRes> Res = StaticCastSharedPtr<FContentItemSpace::FArmyHardModeRes>(resArr[i]);
					Res->UseTextureNum = NewVRSObj->MapCount;
					break;
				}
			}
...
int32 UArmyResourceManager::SearchTextureNumberFromContentItem(TSharedPtr<FContentItemSpace::FContentItem> ContentItem)
{
	if (!ContentItem.IsValid())
		return -1;
	TArray<TSharedPtr<FContentItemSpace::FResObj> >resArr = ContentItem->GetResObjNoComponent();
	...
	{
		if ((resArr[i]->ResourceType == EResourceType::Texture || resArr[i]->ResourceType == EResourceType::Material) &&
			FPaths::GetExtension(resArr[i]->FilePath).Equals(TEXT("pak")))
		{
			return i;
		}
	}
...
FVRSObject* UArmyResourceManager::LoadCustomObj(TSharedPtr<FContentItemSpace::FContentItem> _SynData, int32& _OutObjID, int32& _OutSynID)
{
	TArray<TSharedPtr<FContentItemSpace::FResObj> >resArr = _SynData->GetResObjNoComponent();
	int32 Num = SearchTextureNumberFromContentItem(_SynData);
	if (Num == -1 || (resArr.Num() > 0 && !FPaths::FileExists(resArr[Num]->FilePath)))
		return NULL;
	...
	else
	{
		...
		NewVRSObj.FileName = resArr[Num]->FileName;
		NewVRSObj.FilePath = resArr[Num]->FilePath;
		if (resArr[Num]->ResourceType != None)
		{
			NewVRSObj.Param = StaticCastSharedPtr<FContentItemSpace::FModelRes>(resArr[Num])->MaterialParameter;
		}
...
AActor* UArmyResourceManager::CreateActorFromID(
	UWorld* _OwnerWorld,
	int32 _FileID,
	FName _Name,
	FVector _Location,
	...
	FVector _Scale)
{
	...
	if (NewVRSObj)
	{
		return CreateActorInternal(NewVRSObj, OutObjID, OutSynID, _Name, _Location, _Rotation, _Scale);
	}
	return NULL;
}

FVRSObject* UArmyResourceManager::LoadObj(TSharedPtr<FContentItemSpace::FContentItem> _SynData, int32& _OutObjID, int32& _OutSynID)
{
	TArray<TSharedPtr<FContentItemSpace::FResObj> >resArr = _SynData->GetResObjNoComponent();
...
FVRSObject* UArmyResourceManager::LoadObjFromFileID(int32 _ItemID, int32& _OutObjID, int32& _OutSynID)
{
	TSharedPtr<FContentItemSpace::FContentItem> ResultSynData = NULL;
	int32 ResultSynIndex;
	for (ResultSynIndex = SynList.Num() - 1; ResultSynIndex >= 0; ResultSynIndex--)
	...
	else if (SynList.IsValidIndex(ResultSynIndex))
	{
		...
		if (resArr.Num() < 1)
			return NULL;
		FString Extension = FPaths::GetExtension(resArr[0]->FilePath);
...
bool UArmyResourceManager::LoadObjInternal(FVRSObject& _OutObj)
{
					...
					else if (ThePakType == EResourceType::Material)
					{
						...
						if (MI && !MID)
						{
							...
							if (MID)
							{
								...
								{
									TArray<FArmyParameter> TempParaList;
...
// 					}
			...
			if (ObjectType == TEXT("Model") || ObjectType == TEXT("Actor"))
			{
				...
				if (SocketListNode)
				{
					...
					for (auto& It : ChildrenArray)
					{
						...
						_OutObj.SocketList.Add(FVRSObject::FSocketData(SocketName, SocketLocation, SocketRotation));
					}
				}
			...
			else if (ObjectType == TEXT("Material"))
			{
				...
				const FXmlNode* MapCountNode = XMLRootNode->FindChildNode(TEXT("MapCount"));
				if (MapCountNode)
					_OutObj.MapCount = FCString::Atoi(*MapCountNode->GetContent());

				const FXmlNode* MapSizeNode = XMLRootNode->FindChildNode(TEXT("MapSize"));
				if (MapSizeNode)
					_OutObj.MapSize.InitFromString(*MapSizeNode->GetContent());
							...
							for (int32 i = 0; i < ServerParaList.Num(); i++)
							{
								...
								for (auto& ServerParaIt2 : ServerParaList[i].ParaList)
								{
									for (auto& OutMatDataIt2 : _OutObj.MaterialList[i].ParaList)
									{
										...
										{
											if (ServerParaIt2.VarType == FArmyParameter::E_Float)
											{
											...
											else if (ServerParaIt2.VarType == FArmyParameter::E_Vec3)
											{
									...
									for (auto& ServerParaIt2 : ServerParaIt.ParaList)
									{
										for (auto& OutMatDataIt2 : OutMatDataIt.ParaList)
										{
											...
											if (ServerParaIt2.ID == OutMatDataIt2.ID)
											{
												...
												else if (ServerParaIt2.VarType == FArmyParameter::E_Bool)
												{
...
AActor* UArmyResourceManager::CreateActorInternal(
	...
	FVector _Scale)
{
	...
	/*else if (_ObjectInfo->FileType==EResourceType::Hydropower)
	{
		...
		if(SM!=NULL)
		{
			...
			SpawnInfo.bNoFail=true;
			SpawnInfo.ObjectFlags=RF_Transient;
			AArmyFurnitureActor* SMA=CurWorld->SpawnActor<AArmyFurnitureActor>(SpawnInfo);
	...
	else if (_ObjectInfo->FileType == EResourceType::BlueprintClass)
	{
		...
		if (BP != NULL)
		{
			...
			SpawnParam.Name = _Name;

			AActor* BlueprintActor = CurWorld->SpawnActor<AActor>(BP, _Location, _Rotation, SpawnParam);
			...
			for (int32 i = 0; i < ChildList.Num(); i++)
			{
				...
				if (_ObjectInfo->GetLampMeshObject())
				{
					...
					//@  欧石楠 只有材质附上去后才能正确的关灯，否则自发光的材质会出错
			...
			{
				//获取灯具属性参数，并应用
				TArray<FArmyParameter> ModelSettingsList;
...
// 				GVRSEVC->SetWidgetMode(FArmyWidget::WM_Translate);
...
UMaterialInterface* UArmyResourceManager::CreateMaterialInternal(FVRSObject* _ObjectInfo, int32 _ObjID, int32 _SynID)
{
	UMaterialInterface* NewMaterial = NULL;
	...
	if (_ObjectInfo->FileType == EResourceType::Material)
	{
		...
		if (NewMaterial != NULL)
		{
			...
			NewMaterial->SetObjID(_ObjID);
		}
	}
	return NewMaterial;
}

void UArmyResourceManager::MountPakReturnFiles(FString _PakPath, TArray<FString>& OutPakFilenameList, int32 _Order, bool _IDontWantToMount)
{
...
void UArmyResourceManager::MountPak(FString _PakPath)
{
	FPakFile* PakFile = new FPakFile(PakPlatform.Get(), *_PakPath, false);
...
void UArmyResourceManager::LoadCommonData()
{
	FPlatformFileManager::Get().SetPlatformFile(*PakPlatform);

	//当前只调用Common_9和Common_60
	TArray<FString> Filenames;
	//MountPakReturnFiles(FPaths::ProjectContentDir() + "ZKCache/Common/Common_9.pak", Filenames, 4);
	MountPakReturnFiles(FPaths::ProjectContentDir() + "ZKCache/Common/Common_60.pak", Filenames, 4);
...
void UArmyResourceManager::UnloadModelPak()
{
	for (auto& It : ObjList)
	{
...
// UMaterialInterface* UArmyResourceManager::GetMaterialFromBSP(UArmyModelComponent* _MC)
// {
...
// }
// 
// UMaterialInterface* UArmyResourceManager::GetMaterialFromBSP(const FArmyBspSurf& _Surface)
// {
// 	return _Surface.Material;
// }
// 
// void UArmyResourceManager::SetBSPMaterial(UArmyModelComponent* _MC, UMaterialInterface* _Material)
// {
// 	TIndirectArray<FVRSModelElement>& SourceElements = _MC->GetElements();
...
// }
// 
// void UArmyResourceManager::SetBSPMaterial(FArmyBspSurf* _Surface, UMaterialInterface* _Material)
// {
// 	_Surface->Material = _Material;
// }

void UArmyResourceManager::SetMaterialRotation(UMaterialInstanceDynamic* _MID, float _Angle/*, bool _bUseProjectiveUV*/)
{
	if (_MID)
	{
...
void UArmyResourceManager::SetMaterialOffsetU(UMaterialInstanceDynamic* _MID, float _OffsetU)
{
	if (_MID)
	{
		//检查当前材质是否开启了投射UV
...
void UArmyResourceManager::SetMaterialOffsetV(UMaterialInstanceDynamic* _MID, float _OffsetV)
{
	if (_MID)
	{
		//检查当前材质是否开启了投射UV
...
void UArmyResourceManager::SetMaterialTilingU(UMaterialInstanceDynamic* _MID, float _TilingU)
{
	if (_MID)
	{
		//检查当前材质是否开启了投射UV
...
void UArmyResourceManager::SetMaterialTilingV(UMaterialInstanceDynamic* _MID, float _TilingV)
{
	if (_MID)
	{
		//检查当前材质是否开启了投射UV
...
float UArmyResourceManager::GetMaterialRotation(UMaterialInstanceDynamic* _MID)
{
	float UseProjectiveUV = 0.f;
	float RotateAngle = 0;
	_MID->GetScalarParameterValue(TEXT("UseProjectiveUV"), UseProjectiveUV);
...
float UArmyResourceManager::GetMaterialOffsetU(UMaterialInstanceDynamic* _MID)
{
	float UseProjectiveUV = 0.f;
	float OffsetU = 0.f;
	_MID->GetScalarParameterValue(TEXT("UseProjectiveUV"), UseProjectiveUV);
...
float UArmyResourceManager::GetMaterialOffsetV(UMaterialInstanceDynamic* _MID)
{
	float UseProjectiveUV = 0.f;
	float OffsetV = 0.f;
	_MID->GetScalarParameterValue(TEXT("UseProjectiveUV"), UseProjectiveUV);
...
float UArmyResourceManager::GetMaterialTilingU(UMaterialInstanceDynamic* _MID)
{
	float UseProjectiveUV = 0.f;
	float TilingU = 0.f;
	_MID->GetScalarParameterValue(TEXT("UseProjectiveUV"), UseProjectiveUV);
...
float UArmyResourceManager::GetMaterialTilingV(UMaterialInstanceDynamic* _MID)
{
	float UseProjectiveUV = 0.f;
	float TilingV = 0.f;
	_MID->GetScalarParameterValue(TEXT("UseProjectiveUV"), UseProjectiveUV);
...
bool UArmyResourceManager::GetMaterialUseProjectiveUV(UMaterialInstanceDynamic* _MID)
{
	float UseProjectiveUV = 0.f;
	_MID->GetScalarParameterValue(TEXT("UseProjectiveUV"), UseProjectiveUV);
...
void UArmyResourceManager::ClearActorOverridenMaterials(AActor* _Actor)
{
	if (_Actor)
	{
...
void UArmyResourceManager::ResetActorTransform(AActor* _Actor)
{
	if (_Actor)
	{
...
void UArmyResourceManager::SwitchMaterialUV(UMaterialInstanceDynamic* _MID)
{
	float OldU, OldV;
...
FString UArmyResourceManager::ConvertOldMaterialNameToV7(FString _OldMaterialName)
{
...
int32 UArmyResourceManager::ConvertOldMaterialIDToV7(int32 _OldID)
{
	int32 NewID = 0;
	if (_OldID <= 19)
	{
...
float UArmyResourceManager::ConvertOldOffsetToV7(float _OldOffset)
{
	return FMath::Abs(_OldOffset) * 100.f;
}

float UArmyResourceManager::ConvertOldProjectiveTilingToV7(float _OldTiling)
{
	return _OldTiling * 0.4f;
}

bool UArmyResourceManager::ConvertJsonToModelMaterialList(bool _bConverToV7, FString _ParaStr, TArray<FModelMaterialData>& _OutMaterialList)
{
	if (!_ParaStr.IsEmpty())
	{
					...
					if (arrayPtr2 != nullptr)
					{
						...
						for (int32 j = 0; j < (*arrayPtr2).Num(); ++j)
						{
							...
							if (pos != -1)
							{
								...
								FArmyParameter* result2 = StaticMIParaList.Find(ID);
								if (result2)
								{
									ParaItem.ID = ID;
									if (result2->VarType == FArmyParameter::E_Float)
									{
										float FValue = FCString::Atof(*ParaItemStr);
										ParaItem.VarType = FArmyParameter::E_Float;
										ParaItem.Value = FValue;
										ParaItem.ServerValue = FValue;
										ParaItem.ParaName = result2->ParaName;
									}
									else if (result2->VarType == FArmyParameter::E_Vec3)
									{
										FVector VectorValue;
										//解析Vector类型的XYZ三个值
										...
										ParaItem.VarType = FArmyParameter::E_Vec3;
										ParaItem.Color = VectorValue;
										ParaItem.ServerColor = VectorValue;
										ParaItem.ParaName = result2->ParaName;
									}
									else if (result2->VarType == FArmyParameter::E_Bool)
									{
										float FValue = FCString::Atof(*ParaItemStr);
										ParaItem.VarType = FArmyParameter::E_Bool;
...
FString UArmyResourceManager::ConvertModelMaterialListToJson(TArray<FModelMaterialData>& _MaterialList, bool _bOnlyServerDirty, bool _bOnlyOriginalDirty)
{
	FString JStr;
	bool bEmpty = true;
...
FModelMaterialData UArmyResourceManager::CreateMaterialData(FString _MaterialName, FVector2D _TextureSize, UTexture* _DiffuseMap, UTexture* _NormalMap)
{
	...
	TArray<FArmyParameter> ParaList;
	...
	if (MID)
	{
		...
		for (auto& It : IDList)
		{
			FArmyParameter* result = StaticMIParaList.Find(It);
			if (result)
			{
				float FloatValue = 0.f;
				FLinearColor ColorValue;
				FVector VectorValue;
				if (result->VarType == FArmyParameter::E_Float)
				{
					MID->GetScalarParameterValue(FName(*result->ParaName), FloatValue);
					ParaList.Add(FArmyParameter(result->ParaDisplayName, result->ParaDisplayNameEN, result->ParaName, result->MinValue, result->MaxValue, FloatValue));
				}
				else if (result->VarType == FArmyParameter::E_Vec3)
				{
					...
					ParaList.Add(FArmyParameter(result->ParaDisplayName, result->ParaDisplayNameEN, result->ParaName, VectorValue));
				}
...
FModelMaterialData UArmyResourceManager::CreateModelMaterialData(int32 _Version, FXmlNode* _MaterialNode, TMap<FString, UTexture*>& _TextureMap)
{
	if (_Version == 100)
...
FModelMaterialData UArmyResourceManager::CreateModelMaterialData_Internal_BeforeV7(FXmlNode* _MaterialNode, TMap<FString, UTexture*>& _TextureMap)
{
	...
	for (int32 j = 0; j < ChildrenNodes.Num(); j++)
	{
		...
		else if (ChildNode->GetTag() == TEXT("Parameter"))
		{
			...
			{
				FArmyParameter* result = StaticMIParaList.Find(IDList[k]);
				if (result)
				{
					float FloatValue = 0.f;
					FLinearColor ColorValue;
...
FModelMaterialData UArmyResourceManager::CreateModelMaterialData_Internal_V7(FXmlNode* _MaterialNode, TMap<FString, UTexture*>& _TextureMap)
{
...
FModelMaterialData UArmyResourceManager::CreateModelMaterialDataFromName_V7(int32 _MaterialTypeIndex)
{
	...
	if (MID)
	{
		...
		{
			FArmyParameter* result = StaticMIParaList.Find(ExposedParameters[i]);
			if (result)
			{
				float FloatValue = 0.f;
				FLinearColor ColorValue;
...
void UArmyResourceManager::AddCustomMaterialParametersForMaterialData_V7(FModelMaterialData& _OutMaterialData)
{
	FArmyParameter P_DiffuseUseTexture = StaticMIParaList[-1];
	FArmyParameter P_OpacityUseTexture = StaticMIParaList[-2];
	FArmyParameter P_NormalMapIndex = StaticMIParaList[-3];
	FArmyParameter P_MaterialTypeIndex = StaticMIParaList[-4];
...
int32 UArmyResourceManager::GetNormalTextureIndex(UTexture* _Texture)
{
	int32 BaseIndex = 0;
...
UTexture* UArmyResourceManager::GetNormalTexture(int32 _Index)
{
...
int32 UArmyResourceManager::GetMaterialTypeIndex(FString _MaterialName, bool _bDisplayName /*= false*/)
{
	if (_bDisplayName)
	{
		for (int32 i = 0; i < StaticCommonMaterialList.Num(); i++)
...
void UArmyResourceManager::ChangeModelMaterialData(int32 _NewMaterialTypeIndex, FModelMaterialData* _OldMaterialData)
{
...
bool UArmyResourceManager::ConvertJsonToModelSettingsList(FString _ParaStr, TArray<FArmyParameter>& _OutSettingsList)
{
	if (!_ParaStr.IsEmpty())
	{
			...
			if (arrayPtr != nullptr)
			{
				...
				for (int32 i = 0; i < (*arrayPtr).Num(); ++i)
				{
					...
					if (pos != -1)
					{
						...
						FArmyParameter* result = StaticModelParaList.Find(ID);
						if (result)
						{
							ParaItem.ID = ID;
							if (result->VarType == FArmyParameter::E_Bool)
							{
								float FValue = FCString::Atof(*ParaItemStr);
								ParaItem.VarType = FArmyParameter::E_Bool;
							...
							else if (result->VarType == FArmyParameter::E_Float)
							{
								float FValue = FCString::Atof(*ParaItemStr);
								ParaItem.VarType = FArmyParameter::E_Float;
								ParaItem.Value = FValue;
...
FString UArmyResourceManager::ConvertModelSettingsListToJson(TArray<FArmyParameter>& _SettingsList)
{
	FString JStr;
	TSharedRef<TJsonWriter<TCHAR, TCondensedJsonPrintPolicy<TCHAR>>> JsonWriter = TJsonWriterFactory<TCHAR, TCondensedJsonPrintPolicy<TCHAR>>::Create(&JStr);
	JsonWriter->WriteObjectStart();
	...
	for (auto& It : _SettingsList)
	{
		...
		if (It.VarType == FArmyParameter::E_Bool)
		{
			ValueStr.Append(FString::Printf(TEXT("%d"), It.bCheck ? 1 : 0));
		}
		else if (It.VarType == FArmyParameter::E_Float)
		{
			ValueStr.Append(FString::Printf(TEXT("%.2f"), It.Value));
		}
		else if (It.VarType == FArmyParameter::E_Vec3)
		{
...
void UArmyResourceManager::CollectActorLightComponentsParameters(AActor* _Actor, TArray<FArmyParameter>& _OutSettingsList)
{
		...
		if (ResultObj)
		{
			...
			if (ResultObj->bNormalized)
			{
				...
				if (Points.Num() > 0)
				{
					...
					VColor.Y = LColor.G;
					VColor.Z = LColor.B;
					_OutSettingsList.Add(FArmyParameter("", "", "PointLightCastShadow", Points[0]->CastShadows));
					_OutSettingsList.Last().ID = 0;
					_OutSettingsList.Add(FArmyParameter("", "", "PointLightIntensity", 0, 0, Points[0]->Intensity));
					_OutSettingsList.Last().ID = 1;
					_OutSettingsList.Add(FArmyParameter("", "", "PointLightRadius", 0, 0, Points[0]->AttenuationRadius));
					_OutSettingsList.Last().ID = 2;
					_OutSettingsList.Add(FArmyParameter("", "", "PointLightColor", VColor));
				...
				if (Spots.Num() > 0)
				{
					...
					_OutSettingsList.Add(FArmyParameter("", "", "SpotLightCastShadow", Spots[0]->CastShadows));
					_OutSettingsList.Last().ID = 4;
					_OutSettingsList.Add(FArmyParameter("", "", "SpotLightIntensity", 0, 0, Spots[0]->Intensity));
					_OutSettingsList.Last().ID = 5;
					_OutSettingsList.Add(FArmyParameter("", "", "SpotLightRadius", 0, 0, Spots[0]->AttenuationRadius));
					_OutSettingsList.Last().ID = 6;
					_OutSettingsList.Add(FArmyParameter("", "", "SpotLightInnerAngle", 0, 0, Spots[0]->InnerConeAngle));
					_OutSettingsList.Last().ID = 7;
					_OutSettingsList.Add(FArmyParameter("", "", "SpotLightOutterAngle", 0, 0, Spots[0]->OuterConeAngle));
					_OutSettingsList.Last().ID = 8;
					_OutSettingsList.Add(FArmyParameter("", "", "SpotLightColor", VColor));
					_OutSettingsList.Last().ID = 9;
					_OutSettingsList.Add(FArmyParameter("", "", "SpotLightIES", 0, 0, IESIndex));
...
void UArmyResourceManager::SetActorLightComponentParameters(AActor* _Actor, TArray<FArmyParameter>& _SettingsList)
{
	if (_Actor)
	{
		for (auto& It : _SettingsList)
		{
			if (It.ID == 0)
				FResTools::SetLightComponentCastShadow(true, _Actor, It.bCheck);
			if (It.ID == 1)
				FResTools::SetLightComponentIntensity(true, _Actor, It.Value);
			if (It.ID == 2)
				FResTools::SetLightComponentRadius(true, _Actor, It.Value);
			if (It.ID == 3)
				FResTools::SetLightComponentColor(true, _Actor, FLinearColor(It.Color));
			if (It.ID == 4)
				FResTools::SetLightComponentCastShadow(false, _Actor, It.bCheck);
			if (It.ID == 5)
				FResTools::SetLightComponentIntensity(false, _Actor, It.Value);
			if (It.ID == 6)
				FResTools::SetLightComponentRadius(false, _Actor, It.Value);
			if (It.ID == 7)
				FResTools::SetSpotLightComponentInnerAngle(_Actor, It.Value);
			if (It.ID == 8)
				FResTools::SetSpotLightComponentOutterAngle(_Actor, It.Value);
			if (It.ID == 9)
				FResTools::SetLightComponentColor(false, _Actor, FLinearColor(It.Color));
			if (It.ID == 10 && It.Value != -1 && IESList.IsValidIndex(int32(It.Value)))
			{
				UTextureLightProfile* IES = Cast<UTextureLightProfile>(IESList[int32(It.Value)]);
				if (IES)
					FResTools::SetSpotLightComponentIES(_Actor, IES);
			}
		}
	}
}

UMeshComponent* UArmyResourceManager::GetFirstMeshComponent(AActor* _Actor)
{
	FVRSObject* ResultObj = GetObjFromObjID(_Actor->GetObjID());
...
bool UArmyResourceManager::OverrideMaterialData(FModelMaterialData& _DesData, FModelMaterialData& _SrcData)
{
	if (_DesData.DIM)
	{
...
void UArmyResourceManager::GetMeshMaterialDataFromXMLNode(const FXmlNode* _InNode, FMeshMaterialData& _OutData, FString& _OutActorName)
{
	FString ItemID;
	FString ParaStr;
	float RotateUV = 0.f;
	...
	if (CurLoadPlanVersion >= 5500)
	{
		...
		{
			OffsetU = UArmyResourceManager::ConvertOldOffsetToV7(OffsetU);
			OffsetV = UArmyResourceManager::ConvertOldOffsetToV7(OffsetV);
			if (bUseProjectiveUV)
			{
				TilingU = UArmyResourceManager::ConvertOldProjectiveTilingToV7(TilingU);
				TilingV = UArmyResourceManager::ConvertOldProjectiveTilingToV7(TilingV);
			}
		}
	}
	//旧版本
...
void UArmyResourceManager::AppendSynList(TArray<TSharedPtr<FContentItemSpace::FContentItem>> _NewList)
{
...
void UArmyResourceManager::AddSyncItem(FContentItemPtr NewItem)
{
    bool bFound = false;
    for (auto& SyncItem : SynList)
    {
        if (SyncItem->ID == NewItem->ID)
        {
            bFound = true;
			break;
        }
...
void UArmyResourceManager::ClearData()
{
	UnloadModelPak();
}

void UArmyResourceManager::OnActorPasted(AActor* _Actor)
{
	FVRSObject* ResultObj = GetObjFromObjID(_Actor->GetObjID());
	if (ResultObj)
	{
...
const ANSICHAR* UArmyResourceManager::GetAESKey()
{
	return AESKey;
}

AArmyPointLightActor* UArmyResourceManager::AddPointLight(UWorld* InWorld)
{
	CurWorld = InWorld;
	AArmyPointLightActor* LightActor = CurWorld->SpawnActor<AArmyPointLightActor>(FArmyEngineModule::Get().GetEngineResource()->GetPointLightClass(), FVector(0, 0, 0), FRotator(0, 0, 0));
	LightActor->PointLightCOM->SetIntensity(1500.f);
	LightActor->PointLightCOM->SetAttenuationRadius(500.f);
	LightActor->PointLightCOM->SetSourceRadius(2.f);
	LightActor->Tags.Reset();
	LightActor->Tags.Add(FName("EnvironmentAsset"));
	LightActor->SetActorLabel(FArmyActorLabel::MakePointlightLabel());
	LightActor->SetFolderPath(FArmyActorPath::GetLightSourcePath());
	LightActor->GetRootComponent()->SetMobilityAllChildren(EComponentMobility::Static);

	return LightActor;
}

AArmySpotLightActor* UArmyResourceManager::AddSpotLight(UWorld* InWorld)
{
	CurWorld = InWorld;
	AArmySpotLightActor* LightActor = CurWorld->SpawnActor<AArmySpotLightActor>(FArmyEngineModule::Get().GetEngineResource()->GetSpotLightClass(), FVector(0, 0, 0), FRotator(0, 0, 0));
	LightActor->SpotLightCOM->SetIntensity(1000.f);
	LightActor->SpotLightCOM->SetAttenuationRadius(400.f);
	LightActor->SpotLightCOM->SetSourceRadius(2.f);
	LightActor->Tags.Reset();
	LightActor->Tags.Add(FName("EnvironmentAsset"));
	LightActor->SetActorLabel(FArmyActorLabel::MakeSpotlightLabel());
	LightActor->SetFolderPath(FArmyActorPath::GetLightSourcePath());
	LightActor->GetRootComponent()->SetMobilityAllChildren(EComponentMobility::Static);
	return LightActor;
}

AArmyReflectionCaptureActor* UArmyResourceManager::AddReflectionSphere(UWorld* InWorld)
{
	CurWorld = InWorld;
	AArmyReflectionCaptureActor* RCActor = CurWorld->SpawnActor<AArmyReflectionCaptureActor>(FArmyEngineModule::Get().GetEngineResource()->GetReflectionCaptureClass(), FVector(0, 0, 0), FRotator(0, 0, 0));
	RCActor->SetRadius(500.f);
	RCActor->SetActorEnableCollision(false);
	RCActor->Tags.Reset();
	RCActor->Tags.Add(FName("EnvironmentAsset"));
	RCActor->SetActorLabel(FArmyActorLabel::MakeReflectionCaptureLabel());
	RCActor->SetFolderPath(FArmyActorPath::GetLightSourcePath());

	return RCActor;
}

AArmyLevelAssetBoardActor* UArmyResourceManager::AddLevelAssetBoard(UWorld* InWorld)
{
	CurWorld = InWorld;
	AArmyLevelAssetBoardActor* SpawnedActor = CurWorld->SpawnActor<AArmyLevelAssetBoardActor>(FArmyEngineModule::Get().GetEngineResource()->GetLevelAssetBoardClass(), FVector(0, 0, 0), FRotator(0, 0, 0));
