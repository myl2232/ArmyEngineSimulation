...
class ARMYSCENEDATA_API FArmyPillar : public FArmySimpleComponent
{

public:
	FArmyPillar();
	FArmyPillar(FArmyPillar* Copy);
	virtual ~FArmyPillar();
...
private:
	TSharedPtr<FArmyLine> LeftTopToRightBottomLine;
	TSharedPtr<FArmyLine> LeftBottomToRightTopLine;

	TSharedPtr<FArmyLine> OtherModeLeftTopToRightBottomLine;
	TSharedPtr<FArmyLine> OtherModeLeftBottomToRightTopLine;
};
REGISTERCLASS(FArmyPillar)