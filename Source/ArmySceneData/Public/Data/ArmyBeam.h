...
class ARMYSCENEDATA_API FArmyBeam : public FArmySimpleComponent
{

public:
	FArmyBeam();
	FArmyBeam(FArmyBeam* Copy);
	virtual ~FArmyBeam();	
	...
	/**@欧石楠 自吸附*/
	virtual void AutoAttach(float Invalue = 0.2) override;
