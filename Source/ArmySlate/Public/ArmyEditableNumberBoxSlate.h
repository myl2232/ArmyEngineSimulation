...
*  
*
* @File SArmyEditableNubmerBox.h
* @Description 可编辑的数字输入框，因为改引擎代码很麻烦，所以抄了一份，加以修改
*
* @Author 欧石楠
* @Date 2019年6月23日
* @Version 1.0
...
*/
class ARMYSLATE_API SArmyEditableNumberBox : public SBorder
{

public:

	SLATE_BEGIN_ARGS(SArmyEditableNumberBox)
	...
	/** @欧石楠 仅输入浮点数 */
	SLATE_ATTRIBUTE(bool, IsFloatOnly)
...
protected:
	...
	TSharedPtr< SArmyEditableText > EditableText;
...
private:
    ...
    FMargin GetEditableTextPadding() const { return Img_ToolTip->GetVisibility() == EVisibility::Visible ? FMargin(0, 0, 16, 0) : FMargin(0); }
