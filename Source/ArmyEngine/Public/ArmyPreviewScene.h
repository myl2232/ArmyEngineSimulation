...
//UENUM()
//namespace EArmyThumbnailPrimType
//{
//	enum Type
//	{
//		TPT_None,
...
class ARMYENGINE_API FArmyPreviewScene : public FGCObject
{
...
public:
	...
	FArmyPreviewScene(ConstructionValues CVS = ConstructionValues());
	virtual ~FArmyPreviewScene();
