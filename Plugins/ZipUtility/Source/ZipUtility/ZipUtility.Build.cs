...
public class ZipUtility : ModuleRules
{
    ...
    private string VsDirectory
    {
        ...
        {            
            ...
            string regPath = (string)Registry.GetValue(@"HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Microsoft\VisualStudio\SxS\VS7\", "14.0", "");
    ...
    private string ATLPath
    {
        get
        {
            ...
            try
            {
                ...
                {
                    atlPath = Path.Combine(vsDir, @"VC\atlmfc");
                }
            }
            catch (Exception ex)
            {
