 ...
 */
//@打扮家 XRLightmass 打开调试模式
XRSTATICLIGHTING_API bool GLightmassDebugMode = false; 

/** If true, all participating Lightmass agents will report back detailed stats to the log. */
XRSTATICLIGHTING_API bool GLightmassStatsMode = false;
...
{
	//@打扮家 XRLightmass
	if (bSwarmConnectionIsValid && !FStaticLightingManager::Get()->GetMapBuildCancelled())
	{
...
void FLightmassExporter::WriteStaticMeshes()
{
	...
	//@打扮家 XRLightmass
	for (int32 StaticMeshIndex = 0; StaticMeshIndex < StaticMeshes.Num() && !FStaticLightingManager::Get()->GetMapBuildCancelled(); StaticMeshIndex++)
	{
...
void FLightmassExporter::WriteMappings( int32 Channel )
{
	// bsp mappings
	//@打扮家 XRLightmass
	for (int32 MappingIdx = 0; MappingIdx < BSPSurfaceMappings.Num() && !FStaticLightingManager::Get()->GetMapBuildCancelled(); MappingIdx++)
	{
...
void FLightmassExporter::WriteDebugInput( Lightmass::FDebugLightingInputData& InputData, FGuid& DebugMappingGuid )
{
	...
	InputData.NodeIndex = -1;// GCurrentSelectedLightmapSample.NodeIndex;
	InputData.Position = FVector4(0,0,0,0);// FVector4(GCurrentSelectedLightmapSample.Position, 0);
	InputData.LocalX = -1;//GCurrentSelectedLightmapSample.LocalX;
	InputData.LocalY = -1;//GCurrentSelectedLightmapSample.LocalY;
	InputData.MappingSizeX = -1;//GCurrentSelectedLightmapSample.MappingSizeX;
	InputData.MappingSizeY = -1;//GCurrentSelectedLightmapSample.MappingSizeY;
...
bool FLightmassProcessor::BeginRun()
{
	...
	/*const TCHAR* LightmassExecutable64 = TEXT("D:/UE4.18_BIM/Engine/Binaries/Win64/UnrealLightmass.exe");
	const TCHAR* RequiredDependencyPaths64[] =
	{
		TEXT("D:/UE4.18_BIM/Engine/Binaries/DotNET/SwarmInterface.dll"),
		TEXT("D:/UE4.18_BIM/Engine/Binaries/Win64/AgentInterface.dll"),
		TEXT("D:/UE4.18_BIM/Engine/Binaries/Win64/UnrealLightmass-SwarmInterface.dll"),
		TEXT("D:/UE4.18_BIM/Engine/Binaries/Win64/UnrealLightmass-ApplicationCore.dll"),
		TEXT("D:/UE4.18_BIM/Engine/Binaries/Win64/UnrealLightmass-Core.dll"),
		TEXT("D:/UE4.18_BIM/Engine/Binaries/Win64/UnrealLightmass-CoreUObject.dll"),
		TEXT("D:/UE4.18_BIM/Engine/Binaries/Win64/UnrealLightmass-Projects.dll"),
		TEXT("D:/UE4.18_BIM/Engine/Binaries/Win64/UnrealLightmass-Json.dll"),
		TEXT("D:/UE4.18_BIM/Engine/Binaries/Win64/embree.dll"),
		TEXT("D:/UE4.18_BIM/Engine/Binaries/Win64/tbb.dll"),
		TEXT("D:/UE4.18_BIM/Engine/Binaries/Win64/tbbmalloc.dll")
	};*/

	/*const TCHAR* LightmassExecutable64 = TEXT("D:/UE4.18_BIM/Engine/Binaries/Win64/UnrealLightmass-Win64-Debug.exe");
	const TCHAR* RequiredDependencyPaths64[] =
	{
		TEXT("D:/UE4.18_BIM/Engine/Binaries/DotNET/SwarmInterface.dll"),
		TEXT("D:/UE4.18_BIM/Engine/Binaries/Win64/AgentInterface.dll"),
		TEXT("D:/UE4.18_BIM/Engine/Binaries/Win64/UnrealLightmass-SwarmInterface-Win64-Debug.dll"),
		TEXT("D:/UE4.18_BIM/Engine/Binaries/Win64/UnrealLightmass-ApplicationCore-Win64-Debug.dll"),
		TEXT("D:/UE4.18_BIM/Engine/Binaries/Win64/UnrealLightmass-Core-Win64-Debug.dll"),
		TEXT("D:/UE4.18_BIM/Engine/Binaries/Win64/UnrealLightmass-CoreUObject-Win64-Debug.dll"),
		TEXT("D:/UE4.18_BIM/Engine/Binaries/Win64/UnrealLightmass-Projects-Win64-Debug.dll"),
		TEXT("D:/UE4.18_BIM/Engine/Binaries/Win64/UnrealLightmass-Json-Win64-Debug.dll"),
		TEXT("D:/UE4.18_BIM/Engine/Binaries/Win64/embree.dll"),
		TEXT("D:/UE4.18_BIM/Engine/Binaries/Win64/tbb.dll"),
		TEXT("D:/UE4.18_BIM/Engine/Binaries/Win64/tbbmalloc.dll")
	};*/
...
// 	}
	...
	if (!bOnlyBuildVisibility)
	{
		...
		//@打扮家 XRLightmass
		for (int32 MappingIdx = 0; (ErrorCode >= 0) && MappingIdx < Exporter->BSPSurfaceMappings.Num() && !FStaticLightingManager::Get()->GetMapBuildCancelled(); MappingIdx++)
		{
		...
		//@打扮家 XRLightmass
		for (int32 MappingIdx = 0; (ErrorCode >= 0) && MappingIdx < Exporter->StaticMeshTextureMappings.Num() && !FStaticLightingManager::Get()->GetMapBuildCancelled(); MappingIdx++)
		{
		...
		//@打扮家 XRLightmass
		for (int32 MappingIdx = 0; (ErrorCode >= 0) && MappingIdx < Exporter->LandscapeTextureMappings.Num() && !FStaticLightingManager::Get()->GetMapBuildCancelled(); MappingIdx++)
		{
...
bool FLightmassProcessor::Update()
{
	...
	//@打扮家 XRLightmass
	if (!bQuitReceived && !bProcessingFailed && !FStaticLightingManager::Get()->GetMapBuildCancelled())
	{
...
bool FLightmassProcessor::CompleteRun()
{
	...
	//@打扮家 XRLightmass
	if (!bProcessingFailed && !FStaticLightingManager::Get()->GetMapBuildCancelled())
	{
		ImportVolumeSamples();
...
bool FLightmassProcessor::IsProcessingCompletedSuccessfully() const
{
	//@打扮家 XRLightmass
	return bProcessingSuccessful &&
		!bQuitReceived && !bProcessingFailed && !FStaticLightingManager::Get()->GetMapBuildCancelled();
}
