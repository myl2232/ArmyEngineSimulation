...
#endif
	#include "ArmySwarmInterface/Public/SwarmInterface.h"
...
private:
	...
	friend class FArmyStaticMeshStaticLightingMesh;
	friend class FStaticMeshStaticLightingTextureMapping;
	friend class FArmyStaticMeshStaticLightingTextureMapping;
