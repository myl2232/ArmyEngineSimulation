...
FString FSCTResourceTools::CalcMD5FromFile(FString _FilePath)
{
	TArray<uint8> Result;
...
FString FSCTResourceTools::CalcMD5FromFileData(TArray<uint8>& _FileData)
{
	FMD5 Md5Gen;
...
FString FSCTResourceTools::GetTimeStampString()
{
...
FDateTime FSCTResourceTools::GetDateFromTimeStamp(FString _TimeStamp)
{
...
FDateTime FSCTResourceTools::GetDateFromTimeStamp(int64 _TimeStamp)
{
...
FString FSCTResourceTools::Get24HoursStr(float _Time)
{
...
FString FSCTResourceTools::GetYMDSTimeString()
{
...
void FSCTResourceTools::RedirectHttp(FString Url)
{
    if (Url != "")
    {
